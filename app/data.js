import padra from '@/assets/img/padra.png'
import reactPanel from '@/assets/img/reactPanel.png'
import reactSite from '@/assets/img/reactSite.png'
export const featuredPortfolio = [
  ...
  export const mobilePortfolio = [
    {
      id: 1,
      title: "پنل کاربری با ریکت",
      img: reactPanel
    },
    {
      id: 2,
      title: "سایت فروشگاهی جواهرات",
      img: reactSite
    },
  //   {
  //     id: 3,
