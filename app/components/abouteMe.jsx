...
import aboute from '@/assets/img/aboutme.png'

const AbouteMe = () => {

        return(
        <div className="max-[640px]:flex-col text-white flex p-14 bg-violet-500 " id="AbouteMe">
        <div className="flex-1 p-5 flex justify-center items-center">
            <Image className="object-contain w-full h-full" src={aboute} alt="" />
        </div>
        <div className="flex-1 p-10 flex justify-center overflow-hidden items-center max-[640px]:p-0">
            <span className="max-[640px]:text-[18px] boldShab text-[25px] overflow-hidden ">
