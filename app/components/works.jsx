...
const Works = () => {
  ...
  return (
    <div className="bg-violet-500 flex items-center justify-center relative overflow-hidden" id="Works">
            ...
            <div className=" h-[80%] justify-center items-center flex flex1 max-[640px]:h-[100%]">
              <div className="w-[90%] h-[90%] flex flex-col justify-around ">
                <div className="w-[50px] h-[50px] rounded-full bg-pink-400/50 flex items-center justify-center max-[640px]:w-8 max-[640px]:h-8">
                  <Image className="w-6 max-[640px]:w-2" src={mobile} alt="" />
                </div>
      ...
      <Image onClick={()=>handleClick("left")} className="absolute h-[50px] w-11 left-32 rotate-180 cursor-pointer" src={arrow} alt="" />
      <Image onClick={()=>handleClick("right")} className="absolute h-[50px] w-11 right-32 cursor-pointer" src={arrow} alt="" />
    </div>
  );
};
