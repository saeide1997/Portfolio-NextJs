...
import contact from "@/assets/img/shake.svg"
            ...
            <div className='h-[70%] flex1 flex flex-col items-center justify-center'>
                <h2 className='text-[30px] max-[640px]:text-[25px] overflow-hidden'>با ما در ارتباط باشید...</h2>
                    <form action="" className='w-[100%] h-[100%] flex flex-col items-center justify-evenly'>
                        <input className='max-[640px]:w-[300px] w-[300px] p-3 h-[45px] text-[14px] border border-solid border-violet-700 m-1 rounded-md' type="text" name="" placeholder='ایمیل' id="" />
                        <textarea className='max-[640px]:w-[300px]  w-[300px] p-3 h-[250px] text-[14px] border border-solid border-violet-700 m-1 rounded-md' type="text" name="" placeholder='متن پیام ...' id="" />
